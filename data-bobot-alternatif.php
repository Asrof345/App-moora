        ...
        *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                ...
                <section class="wrapper">
                    ...
                    <h2><i class="fa fa-angle-right"></i> Data Bantuan/Petunjuk</h2>

                    <!-- <div>

                        <span style="float: right; margin: 2rem 0;">

                            <button class="btn btn-theme02" data-toggle="modal" data-target="#ModalTambahKriteria" disabled><i class="fa fa-plus-square"></i> Tambah</button>
                    ...
                    <?php include "table-data-bobot.php" ; ?>
